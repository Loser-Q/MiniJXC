...
/** 编码规则配置 */
export interface BillCodeRuleEntity {
  /**
   * 主键Id
   * @format int64
   */
...
export interface ContactEntity {
   ...
   * @format double
   */
  initPayable?: number | null
  /**
   * 期初应收款（客户）
   * @format double
   */
  initReceivable?: number | null
  /** 是否启用 */
  isEnabled?: boolean
}
...
/** 库存结存输出 */
export interface InventoryBalanceOutput {
  /** @format int64 */
  productId?: number
...
/** 分页信息输入 */
export interface PageInputBillCodeRuleEntity {
  dynamicFilter?: DynamicFilterInfo
  /** 排序列表 */
  sortList?: SortInput[] | null
  /**
...
/** 分页信息输入 */
export interface PageInputInventoryEntity {
  dynamicFilter?: DynamicFilterInfo
  /** 排序列表 */
  sortList?: SortInput[] | null
  /**
...
/** 分页信息输入 */
export interface PageInputPaymentEntity {
  dynamicFilter?: DynamicFilterInfo
  /** 排序列表 */
  sortList?: SortInput[] | null
  /**
...
/** 分页信息输入 */
export interface PageInputPurchaseEntity {
  dynamicFilter?: DynamicFilterInfo
  /** 排序列表 */
  sortList?: SortInput[] | null
  /**
...
/** 分页信息输入 */
export interface PageInputReceiptEntity {
  dynamicFilter?: DynamicFilterInfo
  /** 排序列表 */
  sortList?: SortInput[] | null
  /**
...
/** 分页信息输入 */
export interface PageInputSaleEntity {
  dynamicFilter?: DynamicFilterInfo
  /** 排序列表 */
  sortList?: SortInput[] | null
  /**
...
/** 分页信息输入 */
export interface PageInputStockCheckEntity {
  dynamicFilter?: DynamicFilterInfo
  /** 排序列表 */
  sortList?: SortInput[] | null
  /**
...
/** 分页信息输入 */
export interface PageInputTransferEntity {
  dynamicFilter?: DynamicFilterInfo
  /** 排序列表 */
  sortList?: SortInput[] | null
  /**
...
/** 分页信息输出 */
export interface PageOutputAccountEntity {
  /**
   * 数据总数
   * @format int64
   */
...
/** 分页信息输出 */
export interface PageOutputBillCodeRuleEntity {
  /**
   * 数据总数
   * @format int64
   */
  total?: number
  /** 数据 */
  list?: BillCodeRuleEntity[] | null
}

/** 分页信息输出 */
export interface PageOutputContactEntity {
  /**
   * 数据总数
   * @format int64
   */
...
/** 分页信息输出 */
export interface PageOutputInventoryEntity {
  /**
   * 数据总数
   * @format int64
   */
...
/** 分页信息输出 */
export interface PageOutputPaymentEntity {
  /**
   * 数据总数
   * @format int64
   */
...
/** 分页信息输出 */
export interface PageOutputProductEntity {
  /**
   * 数据总数
   * @format int64
   */
  total?: number
  /** 数据 */
  list?: ProductEntity[] | null
}

/** 分页信息输出 */
export interface PageOutputPurchaseEntity {
  /**
   * 数据总数
   * @format int64
   */
  total?: number
  /** 数据 */
  list?: PurchaseEntity[] | null
}

/** 分页信息输出 */
export interface PageOutputReceiptEntity {
  /**
   * 数据总数
   * @format int64
   */
...
/** 分页信息输出 */
export interface PageOutputSaleEntity {
  /**
   * 数据总数
   * @format int64
   */
...
/** 分页信息输出 */
export interface PageOutputStockCheckEntity {
  /**
   * 数据总数
   * @format int64
   */
...
/** 分页信息输出 */
export interface PageOutputTransferEntity {
  /**
   * 数据总数
   * @format int64
   */
...
/** 分页信息输出 */
export interface PageOutputWarehouseEntity {
  /**
   * 数据总数
   * @format int64
   */
...
/** 结果输出 */
export interface ResultOutputAccountEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputBillCodeRuleEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputContactEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputListInventoryBalanceOutput {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
  ...
  msg?: string | null
  /** 数据 */
  data?: InventoryBalanceOutput[] | null
}
...
/** 结果输出 */
export interface ResultOutputPageOutputAccountEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputPageOutputBillCodeRuleEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
  ...
  msg?: string | null
  /** 分页信息输出 */
  data?: PageOutputBillCodeRuleEntity
}

/** 结果输出 */
export interface ResultOutputPageOutputContactEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputPageOutputInventoryEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
  ...
  msg?: string | null
  /** 分页信息输出 */
  data?: PageOutputInventoryEntity
}
...
/** 结果输出 */
export interface ResultOutputPageOutputPaymentEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputPageOutputProductEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
  ...
  msg?: string | null
  /** 分页信息输出 */
  data?: PageOutputProductEntity
}

/** 结果输出 */
export interface ResultOutputPageOutputPurchaseEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
  ...
  msg?: string | null
  /** 分页信息输出 */
  data?: PageOutputPurchaseEntity
}

/** 结果输出 */
export interface ResultOutputPageOutputReceiptEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputPageOutputSaleEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputPageOutputStockCheckEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
  ...
  msg?: string | null
  /** 分页信息输出 */
  data?: PageOutputStockCheckEntity
}
...
/** 结果输出 */
export interface ResultOutputPageOutputTransferEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputPageOutputWarehouseEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
  ...
  msg?: string | null
  /** 分页信息输出 */
  data?: PageOutputWarehouseEntity
}

/** 结果输出 */
export interface ResultOutputPaymentEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputProductEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputPurchaseEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputReceiptEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputSaleEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputStockCheckEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputTransferEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 结果输出 */
export interface ResultOutputWarehouseEntity {
  /** 是否成功标记 */
  success?: boolean
  /** 编码 */
  code?: string | null
...
/** 库存盘点单 */
export interface StockCheckEntity {
  /**
   * 主键Id
   * @format int64
   */
  ...
  remark?: string | null
  isAudited?: boolean
  items?: StockCheckItemEntity[] | null
}

/** 盘点单明细 */
export interface StockCheckItemEntity {
  /**
   * 主键Id
   * @format int64
   */
